...
var s = new Slide({
	id: "slide",
	cls: "my-theme",
	items: ["images/1.jpg", "images/2.jpg", "images/3.jpg","images/4.jpg","images/5.jpg","images/6.jpg","images/7.jpg","images/8.jpg","images/9.jpg","images/10.jpg","images/11.jpg","images/12.jpg"]
});
var c = new Carousel({
	id: "slide",
	cls: "my-theme",
...
window.onload=function()
{
	...
	document.getElementById("slideshow-option").addEventListener("click",function(){
		...
		if(state=="slide")
		{
			document.getElementById("slideshow-option").innerHTML="自動";
			s.finish();
			c = new Carousel({
				id: "slide",
				cls: "my-theme",
		...
		{
			document.getElementById("slideshow-option").innerHTML="手動";
			c.finish();
			s = new Slide({
				id: "slide",
				cls: "my-theme",
